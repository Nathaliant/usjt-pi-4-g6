				...
				PreparedStatement stm = conn.prepareStatement(sqlSelect);)
		{
			...
			try (ResultSet rs = stm.executeQuery();)
			{
				while (rs.next())
				{
					...
					avaliacao.setUsuario(rs.getInt("tbl_usuario.id_usuario"), rs.getString("tbl_usuario.nome"),
							rs.getString("tbl_usuario.sobrenome"), rs.getString("tbl_usuario.email"),
							rs.getString("tbl_usuario.foto_perfil"));
