...
<div class="card">
	...
	<div class="card-content">
		<form name="form1" action="controller.do" method="post"
			...
			<input name="eId" value="${avaliacao.id_Estabelecimento }"
				type="hidden">
			...
			<div>
				<div id="aNotaSanitarioCadeirante">
					<p>
						<label id="aNotaSanitarioCadeirante">Sanitário cadeirante:
						</label> <select id="star-rating-2" name="aNotaSanitarioCadeirante">
							<option value="">Select a rating</option>
							<option value="5">5</option>
							<option value="4">4</option>
							<option value="3">3</option>
